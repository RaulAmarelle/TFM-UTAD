...
```{r}
# Consideramos que no hay una relacion directa entre el consumo de un dia y del siguiente, la temperatura puede oscilar, la afluencia puede cambiar mucho, etc. Por si el dataset tuviera algunos valores volátiles, voy a eliminar valores atipicos de series temporales
...
Las predicciones no son muy buenas. ¿Cómo mejorar el modelo?
Vamos a utilizar la funcion auto.arima con estacionaliad
