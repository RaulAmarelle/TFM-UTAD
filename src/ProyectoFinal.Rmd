...
```{r}
# Vamos a crear nuevas columnas para dia, mes y aÃ±o, nos pueden ser de utilidad para segmentar las predicciones segun periodo. Vamos a procesar las fechas porque estan como cadena de caracteres.
...
```{r}
# Muy complicado apreciar nada. Parece razonable pensar que dentro de un mismo aÃ±o la serie sigue mas o menos la misma distribucion. Vemos la distribuciÃ³n de la serie para 2017
...
```{r}
# AFLUENCIA agrupada por dÃ­a de la semanas
# suma
...
Se aprecia que hay una progresiva tendencia de disminución del consumo a lo largo de estos dos años, las medidas de ahorro energético están funcionando
...
```{r}
# Igual que la serie entera, pero para hacer el plot de un periodo determinado
